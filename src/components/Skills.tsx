...
function Skills() {
  return (
    <div>
      ...
      <div className="inline p-2 mt-5">
        <div className="inline items-center">
          <div className="flex mb-5">💻 Programming Languages:</div>
          <div className="flex ml-5">
            <div className="flex p-1 bg-button-blue rounded-sm">
            ...
            <div className="flex ml-2 p-1 bg-button-blue rounded-sm">
        ...
        <div className="inline items-center">
          <div className="flex mt-5 mb-5">🌐 Web Development: </div>
          <div className="flex flex-wrap ml-5">
            ...
            <div className="flex mt-5 p-1 bg-button-blue rounded-sm">
            ...
            <div className="flex ml-2 mt-5 p-1 bg-button-blue rounded-sm">
        ...
        <div className="inline items-center mt-5">
          ...
          <div className="flex ml-5">
            ...
            <div className="flex ml-2 p-1 bg-[#006494] rounded-sm">
